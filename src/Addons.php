 ...
 * +----------------------------------------------------------------------
 * | Copyright (c) 2019 http://www.zzstudio.net && https://www.diygw.com All rights reserved.
 * +----------------------------------------------------------------------
 */
...
abstract class Addons
{
    ...
    public function __construct()
    {
        ...
        $this->addon_path   = root_path().'addons'.DIRECTORY_SEPARATOR.$this->name.DIRECTORY_SEPARATOR;
    ...
    final public function setInfo($name = '', $value = [])
    {
        ...
        config($this->infoRange.$name, $info);
